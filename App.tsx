  ...
  return (
    <HelmetProvider>
      {path === '/admin' ? (
        ...
        <div className="min-h-screen bg-slate-950 text-slate-200 font-sans flex flex-col selection:bg-gold-500/30">
          {/* Public Navbar */}
          <nav className="bg-slate-900/80 backdrop-blur-md border-b border-white/5 px-4 py-3 sticky top-0 z-50">
            <div className="max-w-5xl mx-auto flex justify-between items-center">
              <Link href="/" className="font-serif font-bold text-xl tracking-wide text-white">
                rajendranagar<span className="text-gold-500">.online</span>
              </Link>
              ...
              <a
                ...
                className="flex items-center gap-2 bg-gold-500 text-white px-4 py-1.5 rounded-full text-sm font-semibold hover:bg-gold-600 transition-colors shadow-lg shadow-gold-500/20"
              >
          ...
          <footer className="bg-slate-950 text-slate-400 py-12 text-sm border-t border-slate-900 mt-auto">
            <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">

              {/* Column 1: About */}
              <div>
                <h3 className="text-white font-serif font-bold text-lg mb-4">About rajendranagar.online</h3>
                ...
                <div className="text-slate-500 text-sm mb-4">
                  <strong>No Brokerage:</strong> We charge a small listing fee, not a commission.
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><Link href="/" className="hover:text-gold-400 transition-colors">Home Properties</Link></li>
                  ...
                  <li><Link href="/sitemap" className="hover:text-gold-400 transition-colors">Sitemap</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="mb-2 text-slate-500">Call or WhatsApp us for listing or buying:</p>
                <div className="flex flex-col gap-3 items-center md:items-start">
                  <a href="tel:+916281256601" className="flex items-center gap-2 text-white hover:text-gold-400 transition-colors">
                ...
                <p className="mt-6 text-xs text-slate-600">
                  Property Owner? <Link href="/admin" className="underline hover:text-slate-400">Admin Login</Link>
                </p>
              </div>
            </div>

            <div className="max-w-5xl mx-auto px-4 mt-12 pt-8 border-t border-slate-900 text-center text-slate-600 text-xs flex flex-col md:flex-row justify-between items-center gap-2">
